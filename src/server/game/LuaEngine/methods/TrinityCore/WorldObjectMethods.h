...
namespace LuaWorldObject
{
    ...
    {
        E->Push(obj->GetPhaseShift().GetId());
        return 1;
    }
    ...
    */
    int SetPhaseMask(Eluna* E, WorldObject* obj)
    {
        ...
        for (uint32 phaseId = 1; phaseId <= 32; ++phaseId)
        {
            if (phaseMask & (1 << (phaseId - 1)))
                PhasingHandler::AddPhase(obj, phaseId, false);
        }
    ...
    int SummonGameObject(Eluna* E, WorldObject* obj)
    {
        ...
        E->Push(obj->SummonGameObject(entry, Position(x, y, z, o), rot, respawnDelay));
        return 1;
    }
    ...
    int PlayMusic(Eluna* E, WorldObject* obj)
    {
        ...
        WorldPackets::Misc::PlayMusic playMusic(musicid, obj->GetGUID());
