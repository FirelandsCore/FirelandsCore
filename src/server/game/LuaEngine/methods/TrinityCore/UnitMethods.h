...
namespace LuaUnit
{
    ...
    */
    ...
    int DealDamage(Eluna* E, Unit* unit)
    {
        ...
        if (school == MAX_SPELL_SCHOOL)
        {
            Unit::DealDamage(unit, target, damage, 0, DIRECT_DAMAGE, SPELL_SCHOOL_MASK_NORMAL, NULL, durabilityloss);
        ...
        if (!spell)
        {
            ...
            Unit::DealDamage(unit, target, damage, 0, DIRECT_DAMAGE, schoolmask, NULL, false);
