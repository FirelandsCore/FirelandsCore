 ...
 */
 ...
 /* Eluna TODO:
  * ScriptMgr::OnGossipSelect(Player* player, Item* item, uint32 sender, uint32 action)
  * ScriptMgr::OnGossipSelectCode(Player* player, Item* item, uint32 sender, uint32 action, const char* code)
  * ScriptMgr::OnPlayerEmote(Player* player, Emote emote)
  * ScriptMgr::OnGossipSelect(Player* player, uint32 menu_id, uint32 sender, uint32 action)
  * ScriptMgr::OnGossipSelectCode(Player* player, uint32 menu_id, uint32 sender, uint32 action, const char* code)
  * 
 */
